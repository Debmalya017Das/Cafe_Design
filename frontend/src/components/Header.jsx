...
const Header = () => {
  return (
    <header className="bg-white shadow-lg rounded-b-[25px]">
      <div className="container mx-auto px-4 py-2 flex items-center justify-between h-[5rem] ">
        ...
        <nav>
          <ul className="flex space-x-4 ">
            ...
            <li><Link to="/menu" className="text-slate-800 mx-3 hover:text-red-500 hover:scale-110 inline-block duration-300">About Us</Link></li>
            <li><Link to="/shop" className="text-slate-800 mx-3 hover:text-red-500 hover:scale-110 inline-block duration-300">Menu</Link></li>
